...
% Chargement des polices en premier
\usepackage[T1]{fontenc}
\usepackage{lmodern}
\usepackage{helvet}
\renewcommand{\familydefault}{\sfdefault}

% Support utf8 et langue française
...
\renewcommand{\familydefault}{\sfdefault}
\renewcommand\cvheadertitlefontscale{2.0}
\renewcommand\cvsectionfontscale{1.3}
\renewcommand\cvnamefontscale{1.1}
\renewcommand\cvdescriptionfontscale{0.9}
